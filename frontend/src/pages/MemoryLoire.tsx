...
const styles: Record<string, React.CSSProperties> = {
  ...
  board: {
    marginInline: "auto",
    maxWidth: 8 * 120 + 7 * 10, // aprox (8 columnas * 120px + gaps)
  },
  grid: {
    display: "grid",
    gap: 10,
    gridTemplateColumns: "repeat(8, 1fr)", // 8 columnas fijas -> 5 filas (40 cartas)
  },
  cardBtn: {
    position: "relative",
    width: "100%",
  ...
  cardFace: {
    position: "absolute", inset: 0, display: "grid", gridTemplateRows: "1fr auto",
    background: "white", border: "1px solid #e5e7eb", borderRadius: 12,
    transition: "opacity 140ms ease", overflow: "hidden",
  },
  cardBack: {
    position: "absolute", inset: 0, display: "grid", placeItems: "center",
    borderRadius: 12, background: "#e5e7eb", transition: "opacity 140ms ease",
  },
  backInner: {
    width: "68%", height: "68%", display: "grid", placeItems: "center",
    borderRadius: 10, background: "#c7d2fe", fontSize: 26, fontWeight: 700, color: "#111827",
    boxShadow: "inset 0 0 0 2px #93c5fd",
  },
  img: { width: "100%", height: "100%", objectFit: "contain", background: "#f8fafc" },
  caption: {
    fontSize: 11.5, color: "#6b7280", padding: "4px 6px", textAlign: "center",
