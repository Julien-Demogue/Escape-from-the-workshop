...
const CASTLE_POSITIONS = {
  ...
  'heraldry-quiz': { x: 45, y: 34, title: 'Château de Chaumont' },
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <div className="relative w-full h-full">
        ...
        <MagicalQuestionMark key="azay" x={16} y={42} state="unvisited" title="Château d'Azay‑le‑Rideau" />
        <MagicalQuestionMark key="chenonceau" x={40} y={46} state="unvisited" title="Château de Chenonceau" />
        <MagicalQuestionMark key="amboise" x={60} y={34} state="unvisited" title="Château d'Amboise" />
        <MagicalQuestionMark key="blois" x={44} y={28} state="unvisited" title="Château de Blois" />
        <MagicalQuestionMark key="saumur" x={24} y={74} state="unvisited" title="Château de Saumur" />
        <MagicalQuestionMark key="usse" x={72} y={52} state="unvisited" title="Château d'Ussé" />
        <MagicalQuestionMark key="sully" x={82} y={28} state="unvisited" title="Château de Sully‑sur‑Loire" />
        <MagicalQuestionMark key="langeais" x={36} y={50} state="unvisited" title="Château de Langeais" />
        <MagicalQuestionMark key="chinon" x={34} y={62} state="unvisited" title="Château de Chinon" />
        <MagicalQuestionMark key="gizeux" x={62} y={66} state="unvisited" title="Château de Gizeux" />
      </div>
